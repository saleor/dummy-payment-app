...
const SIZE_CONFIG = {
  md: { maxWidth: "280px", padding: 4, borderRadius: 4, number: "•••• •••• •••• 4242", label: "Test cardholder" },
  lg: { maxWidth: undefined, padding: 5, borderRadius: 4, number: "•••• •••• •••• 4242", label: "Test cardholder" },
} as const;
