...
import { PaymentMethodDetailsInputShape } from "@/modules/validation/transaction-create";
          ...
          <Box display="grid" gap={3}>
            ...
            <Box display="grid" gap={1}>
              ...
              <Combobox
                ...
                onChange={(val) =>
                  setPaymentMethodType(val as ComboboxOption<PaymentMethodType>)
                }
                size="small"
              />
              {!giftCardEnabled && (
          ...
          <Box display="grid" gap={3}>
            <Box display="grid" gap={1}>
              ...
              <Combobox
                ...
                onChange={(val) =>
                  setSelectedTransactionId((val as ComboboxOption | null)?.value)
                }
                size="small"
              />
            </Box>
