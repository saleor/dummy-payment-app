...
This project is indexed by GitNexus as **buffalo** (245 symbols, 468 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/buffalo/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/buffalo/context` | Codebase overview, check index freshness |
| `gitnexus://repo/buffalo/clusters` | All functional areas |
| `gitnexus://repo/buffalo/processes` | All execution flows |
| `gitnexus://repo/buffalo/process/{name}` | Step-by-step execution trace |
